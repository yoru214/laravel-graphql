...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [                
                'answer' => App\GraphQL\Queries\AnswerQuery::class,
                'answers' => App\GraphQL\Queries\AnswersQuery::class,
                ...
                'tests' => App\GraphQL\Queries\TestsQuery::class,
            ],
            'mutation' => [
            ...
            'types' => [
                'Answer' => App\GraphQL\Types\AnswerType::class,
